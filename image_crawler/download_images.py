...
def download(name, limit):
    ...
    search = browser.find_elements_by_xpath(
        '/html/body/div/div[3]/form/div[2]/div[1]/div[1]/div/div[2]/input')[0]
    ...
    for i in range(1, (limit+1)):
        try:
            images.append(browser.find_element_by_xpath(
                "/html/body/div[2]/c-wiz/div[3]/div[1]/div/div/div/div/div[1]/div[1]/div["+str(i)+"]/a[1]/div[1]/img"))
        except:
            # scroll the page
        ...
        if src != None:
            try:
                ...
                urllib.request.urlretrieve(str(src), os.path.join(
                    'downloads', file_name+str(count)+'.jpg'))
            except:
                print('fail')
